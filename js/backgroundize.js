// 在手机端显示的背景图片链接
const mobileBgImageUrl = "url('/source/img/BG/bg.png')";

// 在电脑端显示的背景图片链接
const desktopBgImageUrl = "url('/source/img/BG/bg.png')";

// 设置banner的背景图片为空
document.querySelector("#banner").setAttribute('style', 'background-image: url("/source/img/BG/bg.png")');
