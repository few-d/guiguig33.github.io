...
$.ajax({
    ...
    data: {
        key: '5H7BZ-DT333-SZW32-RPWSP-INFA6-EKFZC',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(116.407001, 39.868209, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
